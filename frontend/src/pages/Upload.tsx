  ...
  return (
    <div className="p-8">
      ...
      >
        ...
        <p className="text-sm text-gray-500 mt-1">or click to browse (max 50MB, PDF only)</p>
      </div>
                ...
                <div className="flex items-center gap-3 flex-1">
                  ...
                  {editingId === doc.id ? (
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">{formatDistanceToNow(new Date(doc.created_at))}</p>
                    </div>
                  )}
                </div>
